...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        <li><a class="app-menu__item {{(request()->is(['dashboard','finance','user','chairman','finance/claim']))?'active':''}}" href="
@if(Auth::User()->role_id==1)
        ...
        @if (Auth::User()->role_id==4)
            <li><a class="app-menu__item {{request()->is('dean/all')?'active':''}} " href="{{url('dean/all')}}"><i class="app-menu__icon fa fa-history"></i><span class="app-menu__label">All Claims</span></a></li>
